...
def plot_true_vs_predicted(
    ...
    """Построение scatter plot истинных vs предсказанных значений."""
    ...
    plt.xlabel(r"True aging factor $a_i$")
    plt.ylabel(rf"{pred_label} $\hat{{a}}_i$")
    plt.title(title)
...
def plot_error_histogram(
    ...
    plt.xlabel(r"Error: $a_i - \hat{a}_i$")
    plt.ylabel("Counts")
    plt.title(title)
